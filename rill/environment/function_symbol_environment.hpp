...
namespace rill
{
    ...
    {
        environment_container<BaseEnvT> container;
        ast_to_environment_mapper       ast_to_env_map;
        environment_to_asts_mapper      env_to_asts_map;
    };
    ...
    public:
        ...
        template<typename Tag, typename AstPtr>
        auto mark_as( Tag, intrinsic::single_identifier_value_base_ptr const& name_identifier, AstPtr const& )
        {
            // construct incomplete environment
            auto const& env = incomplete_construct( Tag, name_identifier );
        }
    ...
    private:
        ...
        std::shared_ptr<environment_shared_resource<env_type>> root_shared_resource_;
    };
