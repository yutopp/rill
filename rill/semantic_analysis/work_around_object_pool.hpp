...
// referenced: http://www.boost.org/doc/libs/1_55_0/boost/pool/object_pool.hpp (yutopp)
// http://www.boost.org/doc/libs/1_55_0/libs/pool/doc/html/boost_pool/pool/pooling.html#boost_pool.pool.pooling.user_allocator

#ifndef BOOST_OBJECT_POOL_WORKAROUNDED_HPP
#define BOOST_OBJECT_POOL_WORKAROUNDED_HPP
/*!
\file
\brief  Provides a template type boost::object_pool_workarounded<T, UserAllocator>
...
Class object_pool_workarounded is a template class
that can be used for fast and efficient memory allocation of objects.
It also provides automatic destruction of non-deallocated objects.
...
to the object_pool_workarounded's constructor.
*/

template <typename T, typename UserAllocator = default_user_allocator_new_delete>
class object_pool_workarounded: protected pool<UserAllocator>
{ //!
  public:
  ...
  public:
    explicit object_pool_workarounded(const size_type arg_next_size = 32, const size_type arg_max_size = 0)
    :
...
// ref: http://www.boost.org/doc/libs/1_55_0/boost/pool/detail/pool_construct.ipp
...
object_pool_workarounded<T, UserAllocator>::~object_pool_workarounded()
{
